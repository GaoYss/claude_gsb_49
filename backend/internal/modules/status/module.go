...
// New 构造维修状态查询模块, 依赖路灯 / 故障 / 维修 / 报修四个模块的只读仓储。
func New(db *gorm.DB, lamps *lamp.Repository, faults *fault.Repository, repairs *repair.Repository, reports *report.Repository) *Module {
	service := NewService(db, lamps, faults, repairs, reports)
